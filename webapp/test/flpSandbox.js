		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commvbrgestaogestaoprodutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commvbrgestaogestaoprodutos-display": {
								"semanticObject": "commvbrgestaogestaoprodutos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mvbr.gestao.gestaoprodutos",
									"url": sap.ui.require.toUrl("com/mvbr/gestao/gestaoprodutos")
								}
							}
						}
					}
